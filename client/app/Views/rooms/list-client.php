    ...
    <tbody>
        <?php if (!empty($rooms)): ?>
            <?php foreach ($rooms as $room): ?>
                <tr>
                    <td>
                        <img src="<?= BASE_URL . $room['image'] ?>" alt="<?= $room['name'] ?>" />
                    </td>
                    <td><?= $room['name'] ?></td>
                    <td><?= $room['image'] ?></td>
                    ...
                    <div class="row col-50 mb-minus-24">
                        ...
                        <div class="col-lg-3 col-6 cr-product-box mb-24">
                            <div class="cr-product-card">
                                <div class="cr-product-image">
                                    <div class="cr-image-inner zoom-image-hover">
                                        <img src="./assets/client/assets/img/product/17.jpg" alt="product-1">
                                    </div>
                                    <div class="cr-side-view">
                                        <a href="javascript:void(0)" class="wishlist">
                                            <i class="ri-heart-line"></i>
                        ...
                        <div class="col-lg-3 col-6 cr-product-box mb-24">
                            <div class="cr-product-card">
                                <div class="cr-product-image">
                                    <div class="cr-image-inner zoom-image-hover">
                                        <img src="./assets/client/assets/img/product/13.jpg" alt="product-1">
                                    </div>
                                    <div class="cr-side-view">
                                        <a href="javascript:void(0)" class="wishlist">
                                            <i class="ri-heart-line"></i>
                        ...
                        <div class="col-lg-3 col-6 cr-product-box mb-24">
                            <div class="cr-product-card">
                                <div class="cr-product-image">
                                    <div class="cr-image-inner zoom-image-hover">
                                        <img src="./assets/client/assets/img/product/11.jpg" alt="product-1">
                                    </div>
                                    <div class="cr-side-view">
                                        <a href="javascript:void(0)" class="wishlist">
                                            <i class="ri-heart-line"></i>
                        ...
                        <div class="col-lg-3 col-6 cr-product-box mb-24">
                            <div class="cr-product-card">
                                <div class="cr-product-image">
                                    <div class="cr-image-inner zoom-image-hover">
                                        <img src="./assets/client/assets/img/product/12.jpg" alt="product-1">
                                    </div>
                                    <div class="cr-side-view">
                                        <a href="javascript:void(0)" class="wishlist">
                                            <i class="ri-heart-line"></i>
