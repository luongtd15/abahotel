                ...
                <div class="cr-right-tool cr-flag-drop language">
                    <div class="cr-hover-drop">
                        <div class="cr-hover-tool">
                            <img class="flag" src="<?= BASE_URL ?>assets/admin/assets/img/flag/us.png" alt="flag">
                        </div>
                        <div class="cr-hover-drop-panel right">
                            <ul>
                                <li><a href="javascript:void(0)"><img class="flag" src="<?= BASE_URL ?>assets/admin/assets/img/flag/us.png"
                                            alt="flag">English</a></li>
                                <li><a href="javascript:void(0)"><img class="flag" src="<?= BASE_URL ?>assets/admin/assets/img/flag/in.png"
                                            alt="flag">Hindi</a></li>
                                <li><a href="javascript:void(0)"><img class="flag" src="<?= BASE_URL ?>assets/admin/assets/img/flag/de.png"
                                            alt="flag"> Deutsch</a></li>
                                <li><a href="javascript:void(0)"><img class="flag" src="<?= BASE_URL ?>assets/admin/assets/img/flag/it.png"
                                            alt="flag">Italian</a></li>
                                <li><a href="javascript:void(0)"><img class="flag" src="<?= BASE_URL ?>assets/admin/assets/img/flag/jp.png"
                ...
                <div class="cr-right-tool apps">
                    <div class="cr-hover-drop">
                        ...
                        <div class="cr-hover-drop-panel right">
                            ...
                            <ul>
                                <li><a href="javascript:void(0)"><img class="app" src="<?= BASE_URL ?>assets/admin/assets/img/apps/1.png"
                                            alt="flag">English</a></li>
                                <li><a href="javascript:void(0)"><img class="app" src="<?= BASE_URL ?>assets/admin/assets/img/apps/2.png"
                                            alt="flag">Hindi</a></li>
                                <li><a href="javascript:void(0)"><img class="app" src="<?= BASE_URL ?>assets/admin/assets/img/apps/3.png"
                                            alt="flag"> Deutsch</a></li>
                                <li><a href="javascript:void(0)"><img class="app" src="<?= BASE_URL ?>assets/admin/assets/img/apps/4.png"
                                            alt="flag">Italian</a></li>
                                <li><a href="javascript:void(0)"><img class="app" src="<?= BASE_URL ?>assets/admin/assets/img/apps/5.png"
                                            alt="flag">Japanese</a></li>
                                <li><a href="javascript:void(0)"><img class="app" src="<?= BASE_URL ?>assets/admin/assets/img/apps/6.png"
                                            alt="flag">Japanese</a></li>
                            </ul>
                        </div>
                    </div>
