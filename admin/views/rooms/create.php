                            ...
                            <div class="col-lg-8">
                                <div class="cr-vendor-upload-detail">
                                    <form class="row g-3" method="post" enctype="multipart/form-data">
                                        <!-- Input Room Name -->
                                        <div class="col-md-6">
                                            <label for="inputRoomName" class="form-label">Room Name</label>
                                            <input type="text" class="form-control slug-title" id="inputRoomName" name="inputRoomName">
                                        </div>

                                        <!-- Select Room Type -->
                                        <div class="col-md-6">
                                            <label class="form-label" for="selectRoomType">Select Room Types</label>
                                            <select class="form-control form-select" name="selectRoomType" id="selectRoomType">
                                                <?php foreach ($room_types as $room_type) : ?>
                                                    <option value="<?= $room_type['id_room_type'] ?>"><?= $room_type['name'] ?></option>
                                                <?php endforeach; ?>
                                            </select>
                                        </div>
