                ...
                <div class="cr-message-list">
                    <ul>
                        <li>
                            ...
                            <div class="user">
                                <img src="<?= BASE_URL ?>assets/admin/assets/img/user/9.jpg" alt="user">
                            ...
                            <div class="detail">
                                ...
                                <span class="download-files">
                                    <span class="download">
                                        <img src="<?= BASE_URL ?>assets/admin/assets/img/other/1.jpg" alt="image">
                                        <a href="javascript:void(0)"><i class="ri-download-2-line"></i></a>
                                    </span>
                                    <span class="download">
                                        <img src="<?= BASE_URL ?>assets/admin/assets/img/other/2.jpg" alt="image">
                                        <a href="javascript:void(0)"><i class="ri-download-2-line"></i></a>
                                    </span>
                                    <span class="download">
                                        <span class="file">
                        ...
                        <li>
                            <a href="chatapp.html" class="reply">Reply</a>
                            <div class="user">
                                <img src="<?= BASE_URL ?>assets/admin/assets/img/user/8.jpg" alt="user">
                        ...
                        <li>
                            <a href="chatapp.html" class="reply">Reply</a>
                            <div class="user">
                                <img src="<?= BASE_URL ?>assets/admin/assets/img/user/7.jpg" alt="user">
                        ...
                        <li>
                            <a href="chatapp.html" class="reply">Reply</a>
                            <div class="user">
                                <img src="<?= BASE_URL ?>assets/admin/assets/img/user/6.jpg" alt="user">
                                <span class="label busy"></span>
                            </div>
                            <div class="detail">
                        ...
                        <li>
                            <a href="chatapp.html" class="reply">Reply</a>
                            <div class="user">
                                <img src="<?= BASE_URL ?>assets/admin/assets/img/user/5.jpg" alt="user">
                                <span class="label busy"></span>
                            </div>
                            <div class="detail">
                    ...
                    <ul>
                        ...
                        <li>
                            ...
                            <span class="download-files">
                                ...
                                <span class="download">
                                    <img src="<?= BASE_URL ?>assets/admin/assets/img/other/3.jpg" alt="image">
                                    <a href="javascript:void(0)"><i class="ri-download-2-line"></i></a>
                                </span>
                            </span>
                        </li>
