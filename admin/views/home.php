                                ...
                                <div class="best-seller-table">
                                    <div class="table-responsive">
                                        <table id="best_seller_data_table" class="table">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td><img class="cat-thumb" src="<?= BASE_URL ?>assets/admin/assets/img/clients/1.jpg"
                                                ...
                                                <tr>
                                                    <td><img class="cat-thumb" src="<?= BASE_URL ?>assets/admin/assets/img/clients/2.jpg"
                                                ...
                                                <tr>
                                                    <td><img class="cat-thumb" src="<?= BASE_URL ?>assets/admin/assets/img/clients/3.jpg"
                                                ...
                                                <tr>
                                                    <td><img class="cat-thumb" src="<?= BASE_URL ?>assets/admin/assets/img/clients/4.jpg"
                                                ...
                                                <tr>
                                                    <td><img class="cat-thumb" src="<?= BASE_URL ?>assets/admin/assets/img/clients/5.jpg"
                                                ...
                                                <tr>
                                                    <td><img class="cat-thumb" src="<?= BASE_URL ?>assets/admin/assets/img/clients/6.jpg"
